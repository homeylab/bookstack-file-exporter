...
def test_endpoint_url_scheme_from_secure(make_storage_entry):
    assert S3ProviderConfig._resolve_endpoint_url(make_storage_entry(secure=True)) == "https://minio.local:9000"
    assert S3ProviderConfig._resolve_endpoint_url(make_storage_entry(secure=False)) == "http://minio.local:9000"
